module github.com/swiss-subnet/ssn-console/tools/ssn-admin
...
replace github.com/swiss-subnet/ssn-console/services/canister-clients => ../../services/canister-clients
