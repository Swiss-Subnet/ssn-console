...
type Usage = canister.CanisterUsage
...
type metricDef struct {
	...
	value func(s canister.CyclesMetricsSnapshot) *big.Int
...
var defs = []metricDef{
	{
		...
		value: func(s canister.CyclesMetricsSnapshot) *big.Int { return s.Memory.BigInt() },
	...
	},
	{
		...
		value: func(s canister.CyclesMetricsSnapshot) *big.Int { return s.ComputeAllocation.BigInt() },
	...
	},
	{
		...
		value: func(s canister.CyclesMetricsSnapshot) *big.Int { return s.IngressInduction.BigInt() },
	...
	},
	{
		...
		value: func(s canister.CyclesMetricsSnapshot) *big.Int { return s.Instructions.BigInt() },
	...
	},
	{
		...
		value: func(s canister.CyclesMetricsSnapshot) *big.Int { return s.RequestAndResponseTransmission.BigInt() },
	...
	},
	{
		...
		value: func(s canister.CyclesMetricsSnapshot) *big.Int { return s.Uninstall.BigInt() },
		set:   func(u *Usage, v uint64) { u.Uninstall = v },
	},
	{
		name: "ic_canister_uninstalls_total", description: "Total uninstalls", unit: "count",
		value: func(s canister.CyclesMetricsSnapshot) *big.Int { return div(s.Uninstall.BigInt(), cyclesPerUninstall) },
	...
	},
	{
		...
		value: func(s canister.CyclesMetricsSnapshot) *big.Int { return s.HTTPOutcalls.BigInt() },
	...
	},
	{
		...
		value: func(s canister.CyclesMetricsSnapshot) *big.Int { return s.BurnedCycles.BigInt() },
...
func Build(snapshots []canister.CyclesMetricsSnapshot, environment string) (*mpb.ResourceMetrics, []Usage) {
