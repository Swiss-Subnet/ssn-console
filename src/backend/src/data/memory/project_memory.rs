...
pub type TeamProjectIndexMemory = BTreeSet<(Uuid, Uuid), Memory>;
...
pub fn init_team_project_index() -> TeamProjectIndexMemory {
    TeamProjectIndexMemory::init(get_team_project_index_memory_id())
}
