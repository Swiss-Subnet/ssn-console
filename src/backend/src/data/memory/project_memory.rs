...
pub type ProjectTeamIndexMemory = BTreeSet<(Uuid, TeamId), Memory>;
pub type OrganizationProjectIndexMemory = BTreeSet<(Uuid, Uuid), Memory>;
pub type ProjectTeamPermissionsIndexMemory = BTreeMap<(Uuid, TeamId), ProjectPermissions, Memory>;
pub type TeamProjectPermissionsIndexMemory = BTreeMap<(TeamId, Uuid), ProjectPermissions, Memory>;
