...
pub type ProjectMemory = BTreeMap<ProjectId, Project, Memory>;
pub type ProjectTeamIndexMemory = BTreeSet<(ProjectId, TeamId), Memory>;
pub type OrganizationProjectIndexMemory = BTreeSet<(OrgId, ProjectId), Memory>;
pub type ProjectTeamPermissionsIndexMemory =
    BTreeMap<(ProjectId, TeamId), ProjectPermissions, Memory>;
pub type TeamProjectPermissionsIndexMemory =
    BTreeMap<(TeamId, ProjectId), ProjectPermissions, Memory>;
