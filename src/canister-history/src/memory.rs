use crate::{
    memory_manager::{
        ...
        ORIGIN_TIMESTAMP_CHANGE_INDEX_MEMORY_ID, SUBNET_CANISTER_RANGES_MEMORY_ID,
    },
    model::{CanisterChange, CanisterChangeInfo, SubnetCanisterRangeInfo},
};
use candid::Principal;
use canister_utils::Uuid;
use ic_stable_structures::{BTreeMap, Cell};

pub type SubnetCanisterRangeInfoMemory = Cell<SubnetCanisterRangeInfo, Memory>;
