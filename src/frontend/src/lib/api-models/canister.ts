...
export enum CanisterAvailability {
...
export type CanisterState =
  | { availability: CanisterAvailability.Accessible; info: CanisterInfo }
  | { availability: CanisterAvailability.Inaccessible }
  | { availability: CanisterAvailability.Deleted };
...
function mapCanisterState(state: ApiCanister['state']): CanisterState {
  if ('Accessible' in state) {
    return {
      availability: CanisterAvailability.Accessible,
      info: mapCanisterInfo(state.Accessible),
    };
  }
  if ('Deleted' in state) {
    return { availability: CanisterAvailability.Deleted };
  }
  return { availability: CanisterAvailability.Inaccessible };
}

function mapCanisterInfo(canisterInfo: ApiCanisterInfo): CanisterInfo {
  return {
    status:
